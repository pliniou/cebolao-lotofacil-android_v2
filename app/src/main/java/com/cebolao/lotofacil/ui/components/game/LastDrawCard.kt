...
@Composable
private fun DrawDateSubtitle(draw: Draw) {
...
@Composable
private fun DrawStatisticsSection(draw: Draw) {
    // Layout “flat” e responsivo, com blocos de mesma largura
    Row(
        modifier = Modifier.fillMaxWidth(),
...
@Composable
private fun PrizeTableSection(details: DrawDetails) {
    Text(
...
@Composable
private fun LocationInfoSection(details: DrawDetails) {
    val scheme = MaterialTheme.colorScheme
