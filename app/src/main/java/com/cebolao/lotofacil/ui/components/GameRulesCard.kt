...
fun GameRulesCard(
    ...
    AppCard(
        modifier = modifier
            .fillMaxWidth()
            .animateContentSize(),
        title = "Regras e Premiações", // Should be stringResource ideally, but strictly following instruction to replace component
        outlined = true
    ) {
        Column(
            ...
            if (expanded) {
                ...
                RulesSection(
                    ...
                    Text(
                        text = "A Lotofácil é, como o próprio nome diz, fácil de apostar e ainda mais fácil de ganhar. Você marca entre 15 e 20 números, dentre os 25 disponíveis no volante, e fatura prêmio se acertar 11, 12, 13, 14 ou 15 números.",
                        style = MaterialTheme.typography.bodyMedium,
                        color = scheme.onSurfaceVariant
                    )
                    
                    Text(
                        text = "Surpresinha: deixe que o sistema escolha os números para você.\nTeimosinha: concorra com a mesma aposta por 2, 3, 4, 6, 8, 9, 12, 18 ou 24 concursos consecutivos.",
                        style = MaterialTheme.typography.bodyMedium,
                        color = scheme.onSurfaceVariant
                    )
                }
                ...
                // Preços
                RulesSection(
                    title = "Valores das Apostas",
                    icon = Icons.Outlined.MonetizationOn
                ) {
                    AppTable(
                        headers = listOf("Números", "Valor"),
                        rows = listOf(
                            listOf("15", "R$ 3,50"),
                            listOf("16", "R$ 56,00"),
                            listOf("17", "R$ 476,00"),
                ...
                RulesSection(
                    ...
                    // Custom heavy table layout or simplified list
                    val probabilities = listOf(
                        "15 Números" to listOf("15 acertos: 3.268.760", "14 acertos: 21.792", "13 acertos: 692", "12 acertos: 60", "11 acertos: 11"),
                        "16 Números" to listOf("15 acertos: 204.298", "14 acertos: 3.027", "13 acertos: 162", "12 acertos: 21", "11 acertos: 6"),
                        "17 Números" to listOf("15 acertos: 24.035", "14 acertos: 601", "13 acertos: 49", "12 acertos: 9", "11 acertos: 4"),
                        "18 Números" to listOf("15 acertos: 4.006", "14 acertos: 153", "13 acertos: 18", "12 acertos: 5", "11 acertos: 3"),
                        "19 Números" to listOf("15 acertos: 843", "14 acertos: 47", "13 acertos: 8", "12 acertos: 3,2", "11 acertos: 2,9"),
                        "20 Números" to listOf("15 acertos: 211", "14 acertos: 17", "13 acertos: 4,2", "12 acertos: 2,6", "11 acertos: 3,9")
                    )
