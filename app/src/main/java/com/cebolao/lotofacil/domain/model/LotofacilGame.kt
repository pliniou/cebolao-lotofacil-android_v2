...
data class LotofacilGame private constructor(
    ...
    init {
        ...
        // validação de domínio: todos os números válidos (bits fora do range são ignorados)
    ...
    override fun repeatedFrom(lastDraw: Set<Int>?): Int {
        ...
        // Otimização: usar bitmasks diretamente
